...
you visually inspect the data. This lesson will focus on
graphics. 
...
(`tsc_dir`), we'll read in both data files. **Note** that since we
have two data files this lesson, we'll give them unique names instead
of the normal `df`:
...
they about the same or does one drop mean more than another?
