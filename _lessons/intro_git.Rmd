...
![RStudio gitcred prompt](/edh7916/assets/img/rstudio_gitcred1.png)
...
![GitHub PAT page](/edh7916/assets/img/github_pat.png)

You see a screen that looks like this:

![GitHub PAT page](/edh7916/assets/img/github_pat2.png)
...
![GitHub PAT page](/edh7916/assets/img/gitcreds_set.png)

It will as you to add your password. Paste the `gh_` PAT and press
enter. If it worked, you should see the following:

![GitHub PAT page: finish](/edh7916/assets/img/gitcreds_finish.png)
...
![GitHub student repo](/edh7916/assets/img/github_student_repo.png)

Just above the list of files, click on the button that says clone
(it's green by default).

![GitHub clone](/edh7916/assets/img/github_clone.png)
...
![RStudio new project](/edh7916/assets/img/rstudio_new_project.png)

This window will pop up.

![RStudio new project: version control](/edh7916/assets/img/rstudio_new_project_vc.png)

Choose the option _Version Control_ option. In the next window that
opens, choose _Git_.

![RStudio new project:
git](/edh7916/assets/img/rstudio_new_project_git.png)
...
![RStudio new project:
create](/edh7916/assets/img/rstudio_new_project_create.png) 
...
![RStudio new project: complete](/edh7916/assets/img/rstudio_new_project_complete.png) 
...
![RStudio new project: Git tab](/edh7916/assets/img/rstudio_git_tab.png)
...
diff](/edh7916/assets/img/rstudio_git_diff.png)
...
![RStudio new project: Git history](/edh7916/assets/img/rstudio_git_history.png)
...
![RStudio new project: Git add](/edh7916/assets/img/rstudio_git_add.png)
...
![RStudio new project: Git commit](/edh7916/assets/img/rstudio_git_commit.png)
...
![RStudio new project: Git commit result](/edh7916/assets/img/rstudio_git_commit2.png)
...
![RStudio new project: Git post commit](/edh7916/assets/img/rstudio_git_post_commit.png)
...
![RStudio new project: Git push](/edh7916/assets/img/rstudio_git_push.png)
...
![RStudio new project: Git post push](/edh7916/assets/img/rstudio_git_post_push.png)
...
![RStudio new project: GitHub post push](/edh7916/assets/img/gitHub_post_push.png)
...
![RStudio: pull](/edh7916/assets/img/rstudio_git_pull.png)

If there's nothing new, you'll get a message like this. If so, you're
good to go!

![RStudio: post pull](/edh7916/assets/img/rstudio_git_post_pull.png)
