...
make sense, or you have to translate them from your
perspective. Annoying and useless if you also don't know how to get to
their house.
...
there, you can follow the directions to the park. These directions are
also shareable: anyone who can get to the common landmark can use the
...
starting point --- _e.g._ your `scripts` folder --- they can run you
project easily.
...
scripts so one is fine. But this idea applies within the script
itself: organize your scripts into clear sections so that a person can
easily scan it to see what is happening and where.
...
1. Name it consistent with other items (have a style):
   - `data_1.RDS`
   - `data_2.RDS`
   - `data_3.RDS`
